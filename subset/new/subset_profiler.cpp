...
//----------- Test 000 Insert of a sequent sequence
    ...
    for (int i = 0; i < n; i++)
    {
        ss.insert(&sn, sequent_sequence[i]);
    }
    finish = get_time();
...
//----------- Test 001 Finding of a sequent sequence
    ...
    for (int i = 0; i < n; i++)
    {
        if (!ss.find(sn, sequent_sequence[i]))
        {
...
//----------- Test 002 Remove of a sequent sequence
    ...
    for (int i = 0; i < n; i++)
    {
        ss.remove(&sn, sequent_sequence[i]);
    }
...
//----------- Test 003 Insert of a random sequence (0 - 10)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.insert(&sn, rand_sequence_10[i]);
    }
    finish = get_time();

    auto content = ss.DFS(sn);
    auto size_content = ss.size(sn);
...
//----------- Test 004 Finding of a random sequence (0 - 10)
    ...
    for (int i = 0; i < n; i++)
    {
        if (!ss.find(sn, rand_sequence_10[i]))
        {
            cout <<endl <<"--- !!! Failed insert consistency or find, an element was not found !!! ---" << endl;
            return 0;
        }
...
//----------- Test 005 Remove of a random sequence (0 - 10)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.remove(&sn, rand_sequence_10[i]);
    }
...
//----------- Test 006 Insert of a random sequence (0 - 100)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.insert(&sn, rand_sequence_100[i]);
    }
    finish = get_time();

    content = ss.DFS(sn);
    size_content = ss.size(sn);
    for (int i = 0; i < size_content; i++)
        cout << content[i] << " ";
    cout << endl;
    delete[] content;
...
//----------- Test 007 Finding of a random sequence (0 - 100)
    ...
    for (int i = 0; i < n; i++)
    {
        if (!ss.find(sn, rand_sequence_100[i]))
        {
            cout <<endl <<"--- !!! Failed insert consistency or find, an element was not found !!! ---" << endl;
            return 0;
        }
...
//----------- Test 008 Remove of a random sequence (0 - 100)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.remove(&sn, rand_sequence_100[i]);
    }
...
//----------- Test 009 Insert of a random sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.insert(&sn, rand_sequence_n[i]);
    }
    finish = get_time();
...
//----------- Test 010 Finding of a random sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        if (!ss.find(sn, rand_sequence_n[i]))
        {
            cout <<endl <<"--- !!! Failed insert consistency or find, an element was not found !!! ---" << endl;
            return 0;
        }
...
//----------- Test 011 Remove of a random sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.remove(&sn, rand_sequence_n[i]);
    }
...
//----------- Test 012 Insert of an unique sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.insert(&sn, rand_sequence_unique[i]);
    }
    finish = get_time();
...
//----------- Test 013 Finding of an unique sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        if (!ss.find(sn, rand_sequence_unique[i]))
        {
            cout <<endl <<"--- !!! Failed insert consistency or find, an element was not found !!! ---" << endl;
            return 0;
        }
...
//----------- Test 015 Remove of an unique sequence (0 - n)
    ...
    for (int i = 0; i < n; i++)
    {
        ss.remove(&sn, sorted_sequence_unique[i]);
    }
